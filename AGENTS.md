...
This document defines the specialized roles (agents) that should be adopted when working on the **Fit-Flow** project. Use these personas to guide your tone, focus, and decision-making process.
...
**Responsibilities:**
- Enforce the patterns defined in `conductor/ARCHITECTURE.md`.
...
**Responsibilities:**
- Consult `conductor/product.md` to align with the core vision.
...
- Testing:
  - Follow the TDD workflow defined in `conductor/workflow.md`.
...
**Responsibilities:**
- Refer to `conductor/DATABASE.md` for the current schema.
...
Refer to `conductor/workflow.md` for the strict step-by-step task lifecycle.
