...
6. **Verify Coverage:** Run coverage reports using the project's chosen tools. For FitFlow project:
...
3.  **Execute Automated Tests with Proactive Debugging:**
    ...
    - **Example Announcement:** "I will now run the automated test suite to verify the phase. **Command:** `CI=true npm run test`"
...
# Run tests in watch mode (use CI=true for single execution)
