...
1.  **`EXECUTIVE_SUMMARY.md`**: Understand *why* we are building this (Status: 45% -> MVP).
2.  **`PROJECT_REVIEW.md`**: Understand *how* it is built (Architecture, RLS, Code Patterns).
3.  **`ACTION_PLAN.md`**: Understand *what* to do immediately (Current Sprint).
4.  **`ISSUES.md`**: Specific requirements for tasks (P0 Criticals).
5.  **`conductor/DATABASE.md`**: Database schema and RLS policies (The Law).
